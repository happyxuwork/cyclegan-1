...
class CycleGAN:
    ...
    def train(self):
        ...
        with tf.Session() as sess:
            ...
            print(type(fake_B_temp))
            print(fake_B_temp.shape)
            print(type(fake_A_temp))
            print(fake_A_temp.shape)
           ...
           # kk = sess.run([self.prob_real_a_is_real],feed_dict={inputs:inputs})
            print(yes)
            print("==========image_i============")
